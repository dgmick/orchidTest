...
(function(window, document, $) {
    ...
    ***********************************************************/
    ...
    ios_gradient.addColorStop(0, 'rgba(248, 187, 66, 0.2)');
    ios_gradient.addColorStop(1, 'rgba(248, 187, 66, 0.0)');

    var android_gradient = ctx2.createLinearGradient(0, 0, 0, 400);
    android_gradient.addColorStop(0, 'rgba(55, 188, 155, 0.2)');
    android_gradient.addColorStop(1, 'rgba(55, 188, 155, 0.0)');
    ...
    *****************************************************/
    ...
    $(".knob").knob({
        ...
        draw: function() {
            ...
            style = style.replace("font-size: 30px", "font-size: 50px");
