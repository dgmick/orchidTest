/*=========================================================================================
    File Name: block-matrix.js
    Description: Dimple block matrix chart
    ----------------------------------------------------------------------------------------
...
$(window).on("load", function(){
    ...
    // Construct chart
    var svg = dimple.newSvg("#block-matrix", "100%", 500);
    ...
    d3.tsv("../../../robust-assets/demo-data/dimple/example-data.tsv", function (data) {
        ...
        // Add line
        var s = myChart.addSeries("Price Tier", dimple.plot.bar);
